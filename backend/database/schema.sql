...
CREATE TABLE recipe_tags (
  ...
  CONSTRAINT fk_recipe_recipe_tags
FOREIGN KEY (recipe_id)
REFERENCES recipe(id),
CONSTRAINT fk_tags_recipe_tags
FOREIGN KEY (tags_id)
REFERENCES tags(id)
);
CREATE TABLE user_tags (
  ...
  CONSTRAINT fk_user_user_tags
FOREIGN KEY (user_id)
REFERENCES user(id),
CONSTRAINT fk_tags_user_tags
FOREIGN KEY (tags_id)
REFERENCES tags(id)
);
CREATE TABLE favoris (
  ...
  PRIMARY KEY (user_id, recipe_id),
   CONSTRAINT fk_user_favoris
    FOREIGN KEY (user_id)
    REFERENCES user(id),
  CONSTRAINT fk_recipe_favoris
    FOREIGN KEY (recipe_id)
    REFERENCES recipe(id)
);
...
CREATE TABLE user_ingredient (
  ...
  CONSTRAINT fk_user_user_ingredient
    FOREIGN KEY (user_id)
    REFERENCES user(id),
  CONSTRAINT fk_ingredient_user_ingredient
    FOREIGN KEY (ingredient_id)
    REFERENCES ingredient(id)
);
/* ------------------ ICI LES INSERT ------------------- */
INSERT INTO user (pseudo, email, created_date, updated_date, password, is_admin)
VALUES 
  ('Nadine', 'user1@email.com', '2023-01-01', NULL, 'Motel', TRUE),
  ('Hélène', 'user2@email.com', '2023-01-02', NULL, 'Vernet', TRUE),
  ('Irwin', 'admin1@email.com', '2023-01-03', NULL, 'Soliman', TRUE),
  ('Titouan', 'user3@email.com', '2023-01-04', NULL, 'Gris', TRUE),
  ('Guillaume', 'user4@email.com', '2023-01-05', NULL, 'Lebeau', TRUE),
...
INSERT INTO ingredient (name) VALUES
  ...
  ('Myrtille'),
  ('Noix de coco');
INSERT INTO unit (name) VALUES("g"), ("mL"), ("càs"), ("càc"), ("tasse"), ("pincée"), ("unité"), ("feuille");
...
(3, '', 'Sans Porc'), 
(3, '', 'Pescétarien'), 
(4, '/images/strong-1.png', 'Facile'), 
(4, '/images/strong-2.png', 'Moyen'), 
(4, '/images/strong-3.png', 'Difficile'), 
(5, '/images/chronometre (1).png', '15 min'), 
(5, '/images/chronometre (1).png', '30 min'), 
...
(6, '', 'boisson'),
(6, '', 'apéritif');
>>>>>>> f02bde3e17fcfac02017de733af49a5d5a28719b
...
(4,6),
(4,2);
INSERT INTO favoris (user_id, recipe_id)
VALUES 
(1,1),
(1,2),
(1,5),
